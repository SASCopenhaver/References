...
---------------------------------
  ...
  Begin
    --- DOB preparation:
    select to_date(DECODE(arg_AP_DOB, '', null, arg_AP_DOB), 'DD-MON-YYYY')
      into vAP_DOB
      from dual;
    ...
    update almn
       set almn_pfx_dsc  = arg_AP_Pfx,
           ...
           almn_dob_dt  = DECODE (vAP_DOB,'',null,To_date(vAP_DOB, 'DD-MON-YYYY')),
           ---
/*
  ...
  Begin
    ...
    update usr
       set usr_pfx           = arg_UP_Usr_Prfx,
           ...
           usr_est_depart_dt = TO_DATE(arg_UP_Usr_Est_Depart, 'DD-MON-YYYY')
