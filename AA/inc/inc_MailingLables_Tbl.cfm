  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			...
			<tr>
				<td>
					<select name="ddlbm_CS_From_Cntry" class="forminputs" size="5" multiple 
							onChange="JavaScript:f_AnyChanges('YES'); of_ruleInMultSelectCntrl(this.name); f_showSelection();" > 
  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			...
			<tr>
				<td>
					<select name="ddlbm_CS_Pgm_Type" class="forminputs" size="5" multiple  
							onChange="JavaScript:f_AnyChanges('YES'); of_ruleInMultSelectCntrl(this.name); f_showSelection();" >
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			...
			<tr>
				<td><!--- #client.CS_Host_Instn_Nm# --->
					<!--- 
					<select multiple name="ddlbm_CS_Host_Instn_Nm" onBlur="f_AnyChanges('YES');"  class="forminputs" onChange="JavaScript: of_ruleInMultSelectCntrl(this.name); f_showSelection();"></select>
					<br>
...
//================================================================================================
/*
function of_openLoadingMsg(){with(self.document.forms[0])
{
