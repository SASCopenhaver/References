...
<cfelse>
	<cfset local.Field_Stdy_Nm = Replace(client.CS_Field_Stdy_Nm , "'","''","ALL")>
...
" SELECT "
	...
	&" ||Initcap(decode(nvl(a.almn_last_nm2,''),'','',' '||a.almn_last_nm2))||Initcap(decode(nvl(a.almn_frst_nm,''),'','',', '||a.almn_frst_nm||' '))||Initcap(decode(nvl(a.almn_midl_nm,''),'','',a.almn_midl_nm))|| Chr(60) || '/td' || Chr(62)||"
...
&" WHERE "
	...
	&" and ((a.almn_email1_txt is not null) or (a.almn_email2_txt is not null) or (Trim(a.almn_email1_txt) != '') or (Trim(a.almn_email2_txt) != '')) "
	&local.tblJoint
