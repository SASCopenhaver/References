...
<input type="hidden" name="h_ListType" value="401">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr>
						<td colspan="2">
							...
							<cfif #local.AddCntry# EQ "No additional countries." or #local.AddCntry# EQ "All countries.">
								<span class="c_fieldValue">#local.AddCntry#</span>
							<cfelse>
								<span class="c_fieldValueRed">#local.AddCntry#</span>
							</cfif>
