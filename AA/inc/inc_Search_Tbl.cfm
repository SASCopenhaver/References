...
{//alert("anyChanges")
	//
	if (argAnyChenges == "YES")
	{
		of_innerHTML("id_Search_Nm", "'"+txt_CS_Search_Nm.value+"'");
	}
	//
...
<cfoutput>
	...
	<input type="hidden" name="txt_CS_Search_Nm" value="#client.CS_Search_Nm#" class="forminputs" >
		...
		<table width="100%"  border="0" cellspacing="3" cellpadding="2">
			<tr align="right">
				<td valign="top" colspan="2">
					<input type="button" name="cb_Search1" value="Search" class="c_formbuttons" onClick="JavaScript:f_Search();"><!--- do_totals1(); --->
					&nbsp;&nbsp;
...
<table align="center" width="100%"  border="0" cellspacing="2" cellpadding="2">
    ...
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2"  bgcolor="#EDF7D8">
			<tr bgcolor="#C7DD9C">
				...
				<td class="c_fieldName" width="40%">LAST/FAMILY NAME&nbsp;<cfset local.ctrl_help_ID = "29"><cfinclude template="../Ctrl_Help.cfm"></td>
  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			<tr bgcolor="#C7DD9C">
				<td class="c_fieldName" width="50%">COUNTRY FROM&nbsp;<cfset local.ctrl_help_ID = "30"><cfinclude template="../Ctrl_Help.cfm"></td>
				<td class="c_fieldName">COUNTRY TO&nbsp;<cfset local.ctrl_help_ID = "31"><cfinclude template="../Ctrl_Help.cfm"></td>
			</tr>
			<tr>
				<td>
					<select name="ddlbm_CS_From_Cntry" class="forminputs" size="5"  
							multiple 
							onChange="JavaScript:f_showSelection(); f_AnyChanges('YES'); of_ruleInMultSelectCntrl(this.name);  " > 
				...
				<td>
					<select name="ddlbm_CS_To_Cntry" class="forminputs" size="5" multiple 
							onChange="JavaScript:f_showSelection(); f_AnyChanges('YES'); of_ruleInMultSelectCntrl(this.name);  " >
						<option value="-1">=== All Countries ===</option>
  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			<tr>
				<td class="c_fieldName" bgcolor="#C7DD9C">PROGRAM TYPE&nbsp;<cfset local.ctrl_help_ID = "33"><cfinclude template="../Ctrl_Help.cfm"></td>
			</tr>
			<tr>
				<td>
					<select name="ddlbm_CS_Pgm_Type" class="forminputs" size="5" multiple  onChange="JavaScript: f_showSelection(); f_AnyChanges('YES'); of_ruleInMultSelectCntrl(this.name); ">
						<option value="-1">=== All Program Types ===</option>
  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			<tr bgcolor="#C7DD9C">
				<td class="c_fieldName" width="50%">FISCAL YEAR or PROGRAM START YEAR&nbsp;<cfset local.ctrl_help_ID = "34"><cfinclude template="../Ctrl_Help.cfm"></td>
				<td class="c_fieldName"><cfset local.ctrl_help_ID = "35"><cfinclude template="../Ctrl_Help.cfm"></td>
			</tr>
			<tr>
				<td valign="top">
					<select name="ddlb_CS_Year_Type" class="forminputs" size="4" onChange="JavaScript: f_showSelection(); f_AnyChanges('YES'); f_onChng_YearType(this.value);">
				...
				<td valign="top">
					<select name="ddlb_CS_Year" class="forminputs" multiple onChange="JavaScript: f_showSelection(); f_AnyChanges('YES');"></select>
				</td>
			</tr>
		</table>
		<!--- --------------------------------------------------- --->
...
<table align="center" width="100%"  border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td id="id_CitnshpCntry">
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2"  bgcolor="#EDF7D8">
			<tr bgcolor="#C7DD9C">
				<td class="c_fieldName" width="40%">CITIZENSHIP&nbsp;<cfset local.ctrl_help_ID = "37"><cfinclude template="../Ctrl_Help.cfm"></td>
				<td class="c_fieldName" width="40%">COUNTRY OF RESIDENCE&nbsp;<cfset local.ctrl_help_ID = "38"><cfinclude template="../Ctrl_Help.cfm"></td>
			...
			<tr>
				<td>
					<select name="ddlb_CS_Citznsp_Cntry_CD" class="forminputs" onChange="JavaScript:f_showSelection(); f_AnyChanges('YES'); " ></select>
					
				</td>
				<td>
					<select name="ddlb_CS_Resdnc_Cntry_CD" class="forminputs" onChange="JavaScript:f_showSelection(); f_AnyChanges('YES'); "></select>
				</td>
				<!--- <td>&nbsp;</td> --->
			</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr>
				<td class="c_fieldName" colspan="2">
					For additional "search by" fields, visit the Create and Print section.  Here you may select other fields by which to find alumni records.
				</td>
  ...
  <tr>
    <td >
		...
		<table width="100%"  border="0" cellspacing="3" cellpadding="2">
			<tr align="right">
				<td valign="top" colspan="2">
					<input type="button" name="cb_Search2" value="Search" class="c_formbuttons" onClick="JavaScript: f_Search();"><!--- do_totals1(); --->
					&nbsp;&nbsp;
...
//
of_populateSelect( "ddlb_CS_Citznsp_Cntry_CD", "-1", "=== All Countries ===", rowsConCurr, "orgBfrConCurr", "acntry_cntry_cd", "acntry_cntry_nm", "2D" );
of_selectedInDDLB("ddlb_CS_Citznsp_Cntry_CD", "<cfoutput>#client.CS_Citznsp_Cntry_CD#</cfoutput>");
//
of_populateSelect( "ddlb_CS_Resdnc_Cntry_CD", "-1", "=== All Countries ===", rowsConCurr, "orgBfrConCurr", "acntry_cntry_cd", "acntry_cntry_nm", "2D" );
...
{//alert(h_AnyChanges.value)
	...
	else
	{
		...
		//New code, it replaces the one below
		//
		if (vValidationPassed == "YES" && h_AnyChanges.value == "YES" )
		{
			if ( confirm("Do you want to save these Search Criteria?") )
			{
				//self.document.forms[0].style.cursor = "wait";
				//document.body.style.cursor = "wait";
				f_popupSaveSearchName();
				//of_CallFile("doMailingLables");
				//self.document.forms[0].style.cursor = "default";
...
function f_CntryList(argCntrlName){with(self.document.forms[0])
{
	...
	if (vUsrRole == 245) //it means this is applicable to LES - Localy Engage Staff ONLY
	{// 
		var vF_Temp = "";
		var vF = "";
		var vSelectedID = "";
