...
function f_ShowHideSavedSearches(){with(self.document.forms[0])
{
	...
	switch (vAction)
	{
		case "SHOW"://alert(vAction)
			...
			vAction = "HIDE";
			//
			vList += "<table border=0 width=\"100%\">";
...
<cfif #spr_getCustomSearches.recordCount# NEQ 0>
		<br>
		<table width="60%" border="1" cellspacing="0" cellpadding="0" bgcolor="#EDF7D8">
			...
			<td class="c_fieldName" >
				...
				<hr color="#E20C0C">
			</td><!--- <td class="c_fieldName" >&nbsp;<hr></td> --->
		  </tr>
		  
		  <tr>
		  	<td id="id_ListOfSearches" colspan="2"></td>
		  </tr>
...
<table border="0" cellspacing="1" cellpadding="1">
  <tr>                                                           
    <td width="60%" valign="top" style="border-right-style:groove; border-top-style:groove;"><cfinclude template="inc_Search_Tbl.cfm"></td>
...
//
if (orgBrgCS.length > 0) { of_innerHTML("id_ListOfSearches", "''"); }
//
f_ShowHideSavedSearches();
//
//of_innerHTML("id_ListOfSearches", "'"+vSign+"'");
//
//
//--------------------------------------------------------------------------------------
...
{//alert(arg_SearchID)
	...
	{//alert(orgBrgCS[cs].acust_search_frst_nm)
		...
		{//alert(orgBrgCS[cs].acust_search_id +"   "+ arg_SearchID)
			...
			/////////////////////////			
			//
			//-- Determine if Additional Search criteria should be shown:
			//
			if ( 
				orgBrgCS[cs].acust_search_field_stdy_nm == "nullishere" &&
				orgBrgCS[cs].acust_search_ctznsp_cntry_cd == "-1" &&
				orgBrgCS[cs].acust_search_resdnc_cntry_cd == "-1" &&
				orgBrgCS[cs].acust_search_resdnc_city_nm == "nullishere" &&
				orgBrgCS[cs].acust_search_host_inst_nm == "nullishere" &&
				orgBrgCS[cs].acust_search_city_visit_nm == "nullishere"
		      )
			{
			...
			{
				h_ShowHideAddCriteria.value = "SHOW";
			}
			//
			f_ShowHideAddCriteria()
			//
			
			if (h_ShowHideAddCriteria.value == "HIDE")
			{
			...
			else if (h_ShowHideAddCriteria.value == "SHOW")
			{
				vName = "";
				txt_CS_Field_Stdy_Nm.value = vName;
