  ...
  <tr>
    <td>
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			...
			<tr>
				<td valign="top">
					<select name="ddlb_CS_Year_Type" class="forminputs" size="3" onChange="JavaScript: f_onChng_YearType(this.value); f_showSelection();" onBlur="f_AnyChanges('YES');">
...
<table align="center" width="100%"  border="0" cellspacing="2" cellpadding="2">
   <tr>
  	<td id="id_FieldOfStudy">
		...
		<table width="100%"  border="0" cellspacing="2" cellpadding="2" bgcolor="#EDF7D8">
			<tr>
				<td class="c_fieldName" bgcolor="#C7DD9C">FIELD OF STUDY</td>
			</tr>
			<tr></tr>
				<td>
					<cfoutput>
...
{//alert(h_AnyChanges.value)
	...
	else
	{
		...
		{
			if ( confirm("Do you want to save this Search Criteria?") )
			{
