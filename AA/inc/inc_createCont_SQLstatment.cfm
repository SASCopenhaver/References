...
<cfelse>
	<!--- <cfset local.Field_Stdy_Nm = " and UPPER(fs.field_stdy_nm) like (UPPER('%"&#client.CS_Field_Stdy_Nm#&"%')) "> --->
	<cfset local.Field_Stdy_Nm = " and ("&
								 " ( UPPER(fs.field_stdy_nm) like (UPPER('%"&client.CS_Field_Stdy_Nm&"%')) ) "&
								 " or "&
								 " (UPPER(p.pgm_topic_txt) like (UPPER('%"&client.CS_Field_Stdy_Nm&"%'))) "&
								 " ) ">
</cfif>
...
" SELECT "
    ...
    &" '"&client.Rpt_Type&"', a.almn_id , Chr(60) || 'tr' || Chr(62) || "	
    ...
    &" Chr(60) || 'td' || Chr(62) || decode(a.almn_prefrd_adrs_ind, 'H', a.almn_resdnc_cntry_cd ,'B', a.almn_bsns_cntry_cd, decode(a.almn_resdnc_adrs_txt, null, a.almn_bsns_cntry_cd ,'',a.almn_bsns_cntry_cd ,a.almn_resdnc_cntry_cd ))|| Chr(60) || '/td' || Chr(62)|| "
  	&" Chr(60) || 'td' || Chr(62) || decode(a.almn_prefrd_phone_num_ind,'H','Home: '||nvl(a.almn_resdnc_phone_num,''),"
	&"'B','Work: '||nvl(a.almn_bsns_phone_num,''), "
	&"'C','Cell: '||nvl(a.almn_cell_num,''),"
	&"'O',nvl(a.almn_othr_phone_num,''),"
	&"'F', 'Fax: '||nvl(a.almn_fax_num,''),"
	&" nvl(a.almn_resdnc_phone_num,'')) || Chr(60) || '/td' || Chr(62)||"
    &"  Chr(60) || 'td' || Chr(62) ||decode(a.almn_prefrd_email_ind, '1',nvl(a.almn_email1_txt,''),"
	&" '2',nvl(a.almn_email2_txt,''),"
	&" nvl(a.almn_email1_txt,'')) || Chr(60) || '/td' || Chr(62) ||"
	&" Chr(60) || 'td' || Chr(62) || pt.pgm_type_nm   || Chr(60) || '/td' || Chr(62) ||"
	&" Chr(60) || 'td' || Chr(62) || p.pgm_yr_dt      || Chr(60) || '/td' || Chr(62) ||"
	&" Chr(60) || 'td' || Chr(62) || p.pgm_fy_dt      || Chr(60) || '/td' || Chr(62) ||"
	&" Chr(60) || '/tr' || Chr(62)"
    >
