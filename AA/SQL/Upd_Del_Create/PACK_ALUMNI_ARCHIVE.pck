create or replace package PACK_ALUMNI_ARCHIVE authid definer is
  ...
  ---================================================================================
  procedure sp_mergeJobRecords(arg_Usr_CD IN NUMBER,
                               arg_MRG_ALMN_ID IN NUMBER,
                               arg_MergeJobRecds IN VARCHAR2,
                               arg_LoopNum IN NUMBER);
  ---================================================================================
...
--=========================================================================================  
  ...
  -- 3. Insert values into CONVERTER:
    ...
    END LOOP; 
       ...
       insert into almn_merged am
        select a2.*, 'E', arg_AlmnID, 'P', arg_Usr_CD
        from almn a2
  ...
  update almn
     set --almn_id = v_almn_id,
         ...
         ---
         almn_cntct_ind = arg_ALMN_CNTCT_IND,
         ---
  ...
  Begin 
        ...
        select arg_Usr_CD, a2.almn_id, p.pgm_id
         from almn a1, almn a2, pgm p
         where a2.almn_id = p.pgm_almn_id
               and
               a1.almn_id = arg_MRG_ALMN_ID
               and
                 ...
                 a2.almn_last_nm = a1.almn_last_nm
                 and 
                 p.pgm_from_cntry_cd IN (select distinct p2.pgm_from_cntry_cd  
                                         from pgm p2 
                                         where p2.pgm_almn_id = arg_MRG_ALMN_ID);
         ---
         commit;
         ---
  ...
  -- Delimiter is ";" 
  vPosOfDelimiter NUMBER;
  vMergeJobRecds VARCHAR2(4000);
  vExecStr VARCHAR2(4000);
  ...
  Begin
       ...
       -- II.1:
       select arg_MergeJobRecds into vMergeJobRecds from dual;
