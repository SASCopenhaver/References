create or replace package PACK_ALUMNI_ARCHIVE authid definer is
  ...
  procedure sp_InsUpdAdvCustomSearch(arg_CS_Search_ID in NUMBER,
                                     ...
                                     --arg_CS_ALMN_PROMINENT_CD in varchar2,
                                     arg_CS_Citznsp_Cntry_CD in varchar2,
                                     arg_CS_Resdnc_Cntry_CD  in varchar2,
                                     --
  ...
  procedure sp_getSearchedRecords(arg_Usr_CD            IN NUMBER,
                                  rc_getSearchedRecords OUT refc_Base,
                                    rc_countSearchedAlumni OUT refc_Base);
  ---================================================================================
  ...
  procedure sp_UpdateAlmnRecord ( arg_Usr_CD      IN NUMBER,
                                arg_AP_AlmnID   IN NUMBER,
                                ...
                                ---
                                arg_AP_ALMN_PROMINENT_CD in varchar2
                                );
  ---================================================================================
  ...
  ---================================================================================
  procedure sp_moveOrgAlmnRecds (arg_Usr_CD IN NUMBER,
                                 arg_ALMN_ALL_IDs IN VARCHAR2,
                                 arg_AlmnID IN NUMBER,
                                 arg_ALMN_Loop_Counter IN NUMBER);
  ---================================================================================
  
  
  ---================================================================================
 
  procedure sp_updMergedRecds (
                                arg_Usr_CD IN NUMBER,
                                ---
  ...
  ---================================================================================
  procedure sp_countJobs(arg_MRG_ALMN_ID IN NUMBER,
                         rc_countJobs OUT refc_Base);
  ---================================================================================
  procedure sp_getListOfPrograms(arg_Usr_CD IN NUMBER,
                                 arg_MRG_ALMN_ID IN NUMBER,
                                 rc_getListOfPrograms OUT refc_Base,
                                 rc_getListOfPlaceVisit OUT refc_Base);
  ---================================================================================
  procedure sp_getListOfJobs(arg_Usr_CD IN NUMBER,
                             arg_MRG_ALMN_ID IN NUMBER,
                             rc_getListOfJobs OUT refc_Base);
  ---================================================================================
  procedure sp_saveOrgRecords(arg_Usr_CD IN NUMBER,
                              arg_MRG_ALMN_ID IN NUMBER);
  ---================================================================================
  procedure sp_mergeJobRecords(arg_MergeJobRecds IN VARCHAR2);
  ---================================================================================
  procedure sp_completeJobMerge(arg_MRG_ALMN_ID IN NUMBER);
  ---================================================================================
  procedure sp_mergePgm_and_PV(arg_Usr_CD IN NUMBER,
                              arg_MRG_ALMN_ID IN NUMBER,
                              arg_PgmID_AlmnID_Checked IN VARCHAR2,
                              arg_pgm_type_nm IN NUMBER,
                              arg_pgm_fy_dt IN VARCHAR2,
                              arg_pgm_yr_dt IN VARCHAR2,
                              arg_pgm_from_cntry_nm IN VARCHAR2,
                              arg_pgm_to_cntry_nm IN VARCHAR2,
                              arg_pgm_start_dt IN VARCHAR2,
                              arg_pgm_end_dt IN VARCHAR2,
                              arg_pgm_field_stdy_nm IN NUMBER,
                              arg_pgm_agcy_nm IN VARCHAR2,
                              arg_pgm_plcmnt_org_nm IN VARCHAR2,
                              arg_pgm_nmtng_org_nm IN VARCHAR2,
                              arg_pgm_sub_ctgry_txt IN VARCHAR2,
                              arg_pgm_topic_txt IN VARCHAR2,
                              arg_pgm_strtgc_goal_txt IN VARCHAR2,
                              arg_pgm_spcl_award_txt IN VARCHAR2,
                              arg_PlaceVisited_Checked IN VARCHAR2,
                              rc_continue OUT refc_Base);
  ---================================================================================
  
  procedure sp_getPgmType(rc_getPgmType  OUT refc_Base);
  ---================================================================================
  procedure sp_getFieldOfStudy(rc_getFieldOfStudy OUT refc_Base);
  ---================================================================================
  procedure sp_DelPendingMergedRecds (arg_Usr_CD IN NUMBER);
  ---================================================================================
  procedure sp_getProminent_Categories (spr_Prominent_Categories OUT refc_Base);
  ---================================================================================
  ---================================================================================
  ...
  --=================================================================================
   function f_getProminentNM(arg_prominent_cd IN VARCHAR2) return VARCHAR2;
  --=================================================================================
...
create or replace package body PACK_ALUMNI_ARCHIVE is
  ...
  insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
  values (sysdate, v_ErrorMsg, 0, 'sp_getNavigation');
  ---------------------------------
  ---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getAllNavigationItems');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getTopicTypes');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getInterests');
---------------------------------
---------------------------------
  End sp_getInterests;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_AuthenticateUser');
---------------------------------
--------------------------------- 
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getSecretQuestions');
---------------------------------
---------------------------------   
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getTopics');
---------------------------------
---------------------------------   
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getPrefix');
---------------------------------
---------------------------------    
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getAppRoles');
---------------------------------
--------------------------------- 
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getCountryCityPost');
---------------------------------
--------------------------------- 
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_InsUpdRole');
---------------------------------
--------------------------------- 
    -------------------------------------------------------------
  End sp_InsUpdRole;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_DeleteRole');
---------------------------------
--------------------------------- 
  End sp_DeleteRole;
  ---================================================================================
      ...
      values
        (vUsrID,
         ...
         DECODE(arg_NUR_Usr_Depart_Dt,
                '',
                null,
                TO_DATE(arg_NUR_Usr_Depart_Dt, 'MM/DD/YYYY')),
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_InsUpdNewuserRegistration');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_get_DOS_OfficeCode');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_get_USR_Pass');
---------------------------------
---------------------------------
  End sp_get_USR_Pass;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'get_NUR_UserIDAndStatus');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_NUR_Usr_ID, 'sp_get_NUR_Usr_PreReg');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getAuthAgent');
---------------------------------
---------------------------------
  End sp_getAuthAgent;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getListOfUsers');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getGA_Usr');
---------------------------------
---------------------------------
  End sp_getGA_Usr;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getSelfData');
---------------------------------
---------------------------------
  End sp_getSelfData;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getUsrStatus');
---------------------------------
---------------------------------
  End sp_getUsrStatus;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_GA_UsrID, 'sp_RemoveUsr');
---------------------------------
---------------------------------
  End sp_RemoveUsr;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_GA_UsrID, 'sp_ApprvUsr');
---------------------------------
---------------------------------
  End sp_ApprvUsr;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getCountUsrsByStatus');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_UpdUserData');
---------------------------------
---------------------------------
  End sp_UpdUserData;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getCustomSearches');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getCountries');
---------------------------------
---------------------------------
  End sp_getCountries;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getPrograms');
---------------------------------
---------------------------------
  End sp_getPrograms;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getPgmFiscalYr');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getPgmStartYr');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_InsUpdCustomSearch');
---------------------------------
---------------------------------
    ...
    if arg_CS_Search_ID = 0 then
      ...
      update cust_search
         set cust_search_frst_nm         = DECODE(arg_CS_First_Nm,
             ...
             --,CUST_SEARCH_PROMINENT_CD = arg_CS_ALMN_PROMINENT_CD
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getCustomSearch');
---------------------------------
---------------------------------
  ...
  Begin
    OPEN rc_getCustomSearch FOR
      select cust_search_id,
             ...
             NVL(CUST_SEARCH_PROMINENT_CD, '-1') as CUST_SEARCH_PROMINENT_CD*/
        from cust_search cs
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getCustomSearch');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_deleteCustomSearch');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_execSQL_SelectCount');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_execSQL');
---------------------------------
---------------------------------
  End sp_execSQL;
  ---===============================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_execSQL_RPT');
---------------------------------
---------------------------------
  End sp_execSQL_RPT;
  ---===============================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_execSQL_StatRPT');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_countSearchedRecords');
---------------------------------
---------------------------------
  ...
  procedure sp_getSearchedRecords(arg_Usr_CD            IN NUMBER,
                                  rc_getSearchedRecords OUT refc_Base,
                                    rc_countSearchedAlumni OUT refc_Base) is
  --
  v_ErrorMsg VARCHAR2(200);
  --
  Begin
    ...
    OPEN rc_countSearchedAlumni FOR
      select Count(distinct c.csr_almn_id) AS countAlumni
        from cust_search_rcrd c
       where c.csr_usr_cd = arg_Usr_CD;
---------------------------------
---------------------------------
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getSearchedRecords');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getRprtRecords');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_deleteSearchedRecords');
---------------------------------
---------------------------------
  ...
  Begin
    ...
    OPEN rc_getAlnmProfile FOR
      select almn_id,
             ...
             ----------------------------------------------------------
             DECODE(Trim(almn_prominent_cd),null,'-1','N','-1',Trim(almn_prominent_cd)) as almn_prominent_cd
             ----------------------------------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_AP_AlmnID, 'sp_getAlnmProfile');
---------------------------------
---------------------------------
  ...
  Begin
    ...
    update almn
       set almn_pfx_dsc  = DECODE(arg_AP_Pfx,'-1',null,arg_AP_Pfx),
           ...
           almn_cntct_ind  = DECODE(arg_AP_Cntct_Ind,'-1',null, arg_AP_Cntct_Ind),
           almn_dcsd_ind   = DECODE(arg_AP_Dcsd,'-1','N',arg_AP_Dcsd),
           almn_dsabld_ind = DECODE(arg_AP_Dsabld,'-1','N',arg_AP_Dsabld),
           ---
           ...
           ---
           almn_prominent_cd = Trim(arg_AP_ALMN_PROMINENT_CD)
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_UpdateAlmnRecord');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getHelpTopics');
---------------------------------
---------------------------------
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getCtrlHelp');
---------------------------------
---------------------------------
  End sp_getCtrlHelp;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getHSandCV');
---------------------------------
---------------------------------
  End sp_getHSandCV;
  ---================================================================================
  ...
  Begin
    ...
    ---- 0.
    -- 0.1. Create a record  the city that is not in table CITY
    ...
    ---- 2.3
    -- "-1" No dditional Country in this case DO NOT CREATE any record
    -- "XX" Code  some country , create 1 record with value "XX"
    -- "XX,YY" Codes  two countries, create 2 records with values "XX" and "YY"
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_UP_Usr_ID, 'sp_UpdUserProfileByAuthAgent');
---------------------------------
---------------------------------
  ...
  Begin
    ...
    update usr
       set usr_pfx   = arg_UP_Usr_Prfx,
           usr_fname = UPPER(arg_UP_Usr_FName),
           usr_mi    = UPPER(arg_UP_Usr_MI),
           usr_lname = UPPER(arg_UP_Usr_LName),
           usr_phone = arg_UP_Usr_Phone,
           usr_ext   = arg_UP_Usr_Ext,
           usr_email = arg_UP_Usr_Email,
           usr_uname = arg_UP_Usr_UserName,
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_SelfUpdUsrProfile');
---------------------------------
--------------------------------- 
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_Time_Watch');
---------------------------------
--------------------------------- 
  End sp_Time_Watch;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getTopicsToEdit');
---------------------------------
--------------------------------- 
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_TOPIC_DELETE');
---------------------------------
---------------------------------  
  End sp_TOPIC_DELETE;
  ---================================================================================
  procedure sp_TOPIC_UPDATE(arg_TopicID IN NUMBER,
                            ...
                            arg_topic_is_active IN VARCHAR2,
                            arg_topic_exprtn_dt IN VARCHAR2 ,
                            arg_Elmt_ID_Val IN VARCHAR2,-- mat of arg_Elmt_ID_Val: 1,11;2,12;3,13;
                            arg_NumOfLoops IN NUMBER)
  is
  vPosOfComma NUMBER;
  vPosOfSemiCol NUMBER;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_TOPIC_UPDATE');
---------------------------------
---------------------------------        
  End sp_TOPIC_UPDATE;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_TOPIC_INSERT');
---------------------------------
---------------------------------
  End sp_TOPIC_INSERT;
  ---================================================================================
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_getFilterCriteria');
---------------------------------
---------------------------------
  ...
  Begin
       ...
       select Count(distinct a2.almn_id) as dupsCounter
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_AlmnID, 'sp_checkDups');
---------------------------------
---------------------------------
  End sp_checkDups;
    ---================================================================================
  ...
  Begin
       ...
       select ---
            ...
            NVL(a2.almn_resdnc_postl_cd,'&nbsp;')       as almn_resdnc_postl_cd,
            ...
            ---
            NVL(a2.almn_bsns_nm,'&nbsp;')             as almn_bsns_nm,
            ...
            NVL(a2.almn_bsns_postl_cd,'&nbsp;')       as almn_bsns_postl_cd,
            ...
            ---,
            NVL(a2.almn_cntct_ind,'-1') as almn_cntct_ind,
            ---
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getRecordsToMerge');
---------------------------------
---------------------------------
  ...
  vStrToIns VARCHAR2(100);
  vStrToCut VARCHAR2(1000);
  v_count_all_pgm NUMBER;
  --
  v_ErrorMsg VARCHAR2(200);
  --
  Begin
  -------------------------------------------
  -- 1. "Clean" tbl CONVERTER:
       delete converter c 
       where c.converter_id = arg_Usr_CD;
       commit;
  -------------------------------------------
  -- 2. String is sent in the following format: '123,456,789,', following removes comma from the last position. 
       select Substr(arg_ALMN_ALL_IDs, 1, (Length(arg_ALMN_ALL_IDs)-1) )
              into vStrToCut
       from dual;     
  -------------------------------------------    
  -- 3. Insert values into CONVERTER:
    FOR i IN 1 .. arg_ALMN_Loop_Counter LOOP
           ---
          select Instr(vStrToCut, ',', 1, 1)
            into vPosOfDelimiter
            from dual;
          ...
          End If;
          ---
          insert into converter c
            (c.converter_id, c.converter_val)
          values
            (arg_Usr_CD, TO_NUMBER(vStrToIns));
          commit;
          ---
    ...
    END LOOP; 
       ...
       --------------------------------------------------------------------------------
       -- 1: insert all records to be  merged into almn_merged table with 'E'(eliminated) set to all
       /* select count(pgm_id)
        into v_count_all_pgm
        from pgm1
        where pgm_almn_id in (select almn_id from almn_merged where merged_group_id = arg_AlmnID);
          */   
  ...
  a2.ALMN_DCSD_IND ,
  a2.ALMN_DSABLD_IND,
  a2.ALMN_CTZNSP_CNTRY_CD,
  a2.ALMN_CTZNSP_CNTRY_CD2 ,
  a2.ALMN_RESDNC_ADRS_TXT ,
  a2.ALMN_RESDNC_CITY_NM,
  a2.ALMN_RESDNC_STATE_PRVNC_NM,
  a2.ALMN_RESDNC_CNTRY_CD,
  a2.ALMN_LEGAL_STATE_CD,
  a2.ALMN_CNGRTSNL_DSTRCT_NUM,
  a2.ALMN_BSNS_ADRS_TXT,
  a2.ALMN_BSNS_CITY_NM ,
  a2.ALMN_BSNS_STATE_PRVNC_NM,
  a2.ALMN_BSNS_CNTRY_CD,
  a2.ALMN_PREFRD_ADRS_IND,
  a2.ALMN_RESDNC_PHONE_NUM,
  a2.ALMN_BSNS_PHONE_NUM,
  a2.ALMN_CELL_NUM,
  a2.ALMN_OTHR_PHONE_NUM,
  a2.ALMN_PREFRD_PHONE_NUM_IND,
  a2.ALMN_FAX_NUM,
  a2.ALMN_EMAIL1_TXT,
  a2.ALMN_EMAIL2_TXT,
  a2.ALMN_PREFRD_EMAIL_IND,
  a2.ALMN_CNTCT_IND,
  a2.ALMN_ELP_SPEAK_FSI_LEVEL_NUM,
  a2.ALMN_ELP_READ_FSI_LEVEL_NUM,
  a2.ALMN_ELP_COMP_FSI_LEVEL_NUM,
  a2.ALMN_NOTES_TXT,
  a2.ALMN_CRTD_DT,
  a2.ALMN_CRTD_ID,
  a2.ALMN_UPDT_ID,
  ...
  a2.ALMN_BSNS_NM ,
  a2.ALMN_BSNS_POSTL_CD,
  a2.ALMN_RESDNC_POSTL_CD, 'E', arg_AlmnID, 'P', arg_Usr_CD, v_count_all_pgm, a2.almn_prominent_cd
        from almn a2
        where a2.almn_id IN ( select c.converter_val 
                              from converter c
                              where c.converter_id = arg_Usr_CD );                       
       ...
       --- update almn_merged set 'M'(merged) to the selected record that will remain in the almn table
        update almn_merged
          set almn_merged_cd = 'M'
        ...
        update almn_merged
          set merge_orig_pgm_count = v_count_all_pgm
        where merged_group_id = arg_AlmnID;
       
       ---
       commit;
       ---
       -------------------
       -- 2: Hide all records to be merged, so the users will not be able to see and update them
       update almn
          set show_almn_ind = 'N'
        where almn_id  IN ( select c.converter_val 
                              from converter c
                              where c.converter_id = arg_Usr_CD );  
                              /*
                              select a2.almn_id
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getPgmRecds');
---------------------------------
---------------------------------      
       -------------------
  ...
  update almn
     set --almn_id = v_almn_id,
         almn_pfx_dsc  = DECODE(arg_ALMN_PFX_DSC,'-1', null,arg_ALMN_PFX_DSC),
         almn_last_nm  = arg_ALMN_LAST_NM,
         almn_last_nm2 = DECODE(TRIM(arg_ALMN_LAST_NM2),'',null,TRIM(arg_ALMN_LAST_NM2)),
         almn_frst_nm  = DECODE(TRIM(arg_ALMN_FRST_NM),'',null,TRIM(arg_ALMN_FRST_NM)),
         almn_midl_nm  = DECODE(TRIM(arg_ALMN_MIDL_NM),'',null,TRIM(arg_ALMN_MIDL_NM)),
         almn_sfx_dsc  = DECODE(TRIM(arg_ALMN_SFX_DSC),'',null,TRIM(arg_ALMN_SFX_DSC)),
         ---
         almn_sex_ind = DECODE(arg_ALMN_SEX_IND,'-1',null,arg_ALMN_SEX_IND),
         almn_dob_dt  = To_date(arg_ALMN_DOB_DT, 'MM/DD/YYYY'),
         ---
         almn_dcsd_ind   = DECODE(arg_ALMN_DCSD_IND,  '-1','N',arg_ALMN_DCSD_IND),
         almn_dsabld_ind = DECODE(arg_ALMN_DSABLD_IND,'-1','N',arg_ALMN_DSABLD_IND),
         ---
         almn_ctznsp_cntry_cd  = DECODE(arg_ALMN_CTZNSP_CNTRY_CD, '-1',null,arg_ALMN_CTZNSP_CNTRY_CD),
         almn_ctznsp_cntry_cd2 = DECODE(arg_ALMN_CTZNSP_CNTRY_CD2,'-1',null,arg_ALMN_CTZNSP_CNTRY_CD2),
         ---
         almn_resdnc_adrs_txt = DECODE(Trim(arg_ALMN_RESDNC_ADRS_TXT), '',null,Trim(arg_ALMN_RESDNC_ADRS_TXT)),
         almn_resdnc_city_nm = DECODE(Trim(arg_ALMN_RESDNC_CITY_NM),'',null,Trim(arg_ALMN_RESDNC_CITY_NM)),
         almn_resdnc_state_prvnc_nm = DECODE(Trim(arg_ALMN_RESDNC_STATE_PRVNC_NM),'',null,Trim(arg_ALMN_RESDNC_STATE_PRVNC_NM)),
         almn_resdnc_cntry_cd = DECODE(arg_ALMN_RESDNC_CNTRY_CD, '-1',null,arg_ALMN_RESDNC_CNTRY_CD),
         ---
         --almn_legal_state_cd = v_almn_legal_state_cd,
         --almn_cngrtsnl_dstrct_num = v_almn_cngrtsnl_dstrct_num,
         ---
         almn_bsns_adrs_txt = DECODE(Trim(arg_ALMN_BSNS_ADRS_TXT), '',null,Trim(arg_ALMN_BSNS_ADRS_TXT)),
         almn_bsns_city_nm = DECODE(Trim(arg_ALMN_BSNS_CITY_NM),'',null,Trim(arg_ALMN_BSNS_CITY_NM)),
         almn_bsns_state_prvnc_nm = DECODE(Trim(arg_ALMN_BSNS_STATE_PRVNC_NM),'',null,Trim(arg_ALMN_BSNS_STATE_PRVNC_NM)),
         almn_bsns_cntry_cd = DECODE(arg_ALMN_BSNS_CNTRY_CD, '-1',null,arg_ALMN_BSNS_CNTRY_CD),
         ---
         almn_prefrd_adrs_ind = arg_ALMN_PREFRD_ADRS_IND,
         ---
         almn_resdnc_phone_num = DECODE(Trim(arg_ALMN_RESDNC_PHONE_NUM),'',null,Trim(arg_ALMN_RESDNC_PHONE_NUM)),
         almn_bsns_phone_num = DECODE(Trim(arg_ALMN_BSNS_PHONE_NUM),'',null,Trim(arg_ALMN_BSNS_PHONE_NUM)),
         almn_cell_num = DECODE(Trim(arg_ALMN_CELL_NUM),'',null,Trim(arg_ALMN_CELL_NUM)),
         almn_othr_phone_num = DECODE(Trim(arg_ALMN_OTHR_PHONE_NUM),'',null,Trim(arg_ALMN_OTHR_PHONE_NUM)),
         ---
         almn_fax_num = DECODE(Trim(arg_ALMN_FAX_NUM),'',null,Trim(arg_ALMN_FAX_NUM)),
         ---
         almn_prefrd_phone_num_ind = arg_ALMN_PREFRD_PHONE_NUM_IND,
         ---
         almn_email1_txt = DECODE(Trim(arg_ALMN_EMAIL1_TXT),'',null,Trim(arg_ALMN_EMAIL1_TXT)),
         almn_email2_txt = DECODE(Trim(arg_ALMN_EMAIL2_TXT),'',null,Trim(arg_ALMN_EMAIL2_TXT)),
         ---
         almn_prefrd_email_ind = arg_ALMN_PREFRD_EMAIL_IND,
         ---
         almn_cntct_ind = DECODE(arg_ALMN_CNTCT_IND,'-1',null,arg_ALMN_CNTCT_IND),
         ---
         almn_elp_speak_fsi_level_num = DECODE(arg_ALMN_ELP_SPEAK_FSI_NUM,-1,null,arg_ALMN_ELP_SPEAK_FSI_NUM),
         almn_elp_read_fsi_level_num  = DECODE(arg_ALMN_ELP_READ_FSI_NUM,-1,null,arg_ALMN_ELP_READ_FSI_NUM),
         almn_elp_comp_fsi_level_num  = DECODE(arg_ALMN_ELP_COMP_FSI_NUM,-1,null,arg_ALMN_ELP_COMP_FSI_NUM),
         ---
         almn_notes_txt = DECODE(Trim(arg_ALMN_NOTES_TXT),'',null,Trim(arg_ALMN_NOTES_TXT)),
         ---
         ---almn_crtd_dt = v_almn_crtd_dt,
         ---almn_crtd_id = v_almn_crtd_id,
         ---
         almn_updt_id = arg_Usr_CD,
         almn_updt_dt = sysdate--,
         ---
         --original_almn_id = v_original_almn_id,
         --pgm_src_nm = v_pgm_src_nm,
         --show_almn_ind = v_show_almn_ind,
         --almn_bsns_nm = v_almn_bsns_nm,
         --almn_bsns_postl_cd = v_almn_bsns_postl_cd,
         --almn_resdnc_postl_cd = v_almn_resdnc_postl_cd
   where almn_id = arg_MRG_ALMN_ID ;
   ...
   /*IN 
                    (
                     ...
                     where a2.almn_id = p.pgm_almn_id
                           and
                           a1.almn_id = arg_MRG_ALMN_ID
                           and
                             (p.show_pgm_ind = 'Y' and a2.show_almn_ind = 'N')
                             --- 
                             and
                             a2.almn_frst_nm = a1.almn_frst_nm
                             and
                             ...
                             a2.almn_last_nm = a1.almn_last_nm
                             and 
                             p.pgm_from_cntry_cd IN (select distinct p2.pgm_from_cntry_cd  from pgm p2 where p2.pgm_almn_id = arg_MRG_ALMN_ID)
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_MRG_ALMN_ID, 'sp_getPgmRecds');
---------------------------------
--------------------------------- 
  End sp_updMergedRecds;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_AlmnID, 'sp_getPgmRecds');
---------------------------------
--------------------------------- 
  End sp_getPgmRecds;
  ---================================================================================
  ...
  --
  Begin
       OPEN rc_countJobs  FOR
       select Count(*) as JobCounter
       from job j
       where j.job_almn_id IN 
                    ( select am.almn_id 
                     from almn_merged am
                     where am.merge_status = 'P' and 
                           am.merged_group_id = arg_MRG_ALMN_ID);
                     /*select a2.almn_id
                     from almn a1, almn a2, pgm p
                     where a2.almn_id = p.pgm_almn_id
                           and
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_MRG_ALMN_ID, 'sp_countJobs');
---------------------------------
---------------------------------
  End sp_countJobs;
  ---================================================================================
  ...
  Begin 
        ...
        --2:
        insert into converter c (c.converter_id, c.converter_val, c.converter_pgm_id)
        select arg_Usr_CD, p.pgm_almn_id, p.pgm_id
         from pgm p
         where p.pgm_almn_id IN 
                    ( select am.almn_id 
                     from almn_merged am
                     where am.merge_status = 'P' and 
                           am.merged_group_id = arg_MRG_ALMN_ID);
         ...
         select p.pgm_id,
                ...
                p.pgm_fy_dt,
                p.pgm_yr_dt,
                TO_CHAR(p.pgm_start_dt,'mm/dd/yyyy') as pgm_start_dt,
                TO_CHAR(p.pgm_end_dt,  'mm/dd/yyyy') as pgm_end_dt,
                --
                p.pgm_from_cntry_cd,
                f_getCntryNM(p.pgm_from_cntry_cd) as pgm_from_cntry_nm,
                --
                ...
                --
                p.pgm_field_stdy_cd,
                f_getFieldStdyNM(p.pgm_field_stdy_cd) as pgm_field_stdy_nm,
                --
                p.pgm_agcy_nm,
                p.pgm_plcmnt_org_nm,
                p.pgm_nmtng_org_nm,
                p.pgm_sub_ctgry_txt,
                p.pgm_topic_txt,
                p.pgm_strtgc_goal_txt,
                p.pgm_spcl_award_txt,
                --p.pgm_crtd_dt, p.pgm_crtd_id, 
                TO_CHAR(p.pgm_updt_dt,  'mm/dd/yyyy') as pgm_updt_dt,
                p.pgm_updt_id,
                --, p.original_pgm_id,
                --p.original_almn_id, 
                p.pgm_src_nm
                --, p.show_pgm_ind
           from pgm p, pgm_type pt, converter c
           where p.pgm_type_cd = pt.pgm_type_cd
                 and
                 p.pgm_almn_id = c.converter_val 
                 and 
                 c.converter_id = arg_Usr_CD and p.pgm_id not in 
                 (select pgm_id
                 from pgm_merged 
                 where merged_group_almn_id = arg_MRG_ALMN_ID
                 and merge_status = 'C' and merge_usr_id = arg_Usr_CD)
           order by p.pgm_yr_dt, p.pgm_fy_dt, p.pgm_from_cntry_cd, p.pgm_to_cntry_cd;
         ---
         OPEN rc_getListOfPlaceVisit  FOR
         select pv.place_visit_pgm_id,
                pv.place_visit_almn_id,
                NVL(place_visit_city_nm, 'no data') as place_visit_city_nm,
                NVL(place_visit_state_prvnc_nm,'no data') as place_visit_state_prvnc_nm,
                place_visit_cntry_cd,
                f_getCntryNM(place_visit_cntry_cd) as place_visit_cntry_nm,
                NVL(place_visit_host_instn_nm,' ') as place_visit_host_instn_nm
           from place_visit pv, converter c
           where pv.place_visit_pgm_id = c.converter_pgm_id
                 and
                 pv.place_visit_almn_id = c.converter_val and c.converter_id = arg_Usr_CD ;
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getListOfPrograms');
---------------------------------
---------------------------------                               
  End sp_getListOfPrograms;
  ---================================================================================
  procedure sp_getListOfJobs(arg_Usr_CD IN NUMBER,
                             arg_MRG_ALMN_ID IN NUMBER,
                             rc_getListOfJobs OUT refc_Base)
  ...
  Begin
        ...
        -- 2:
        insert into converter c (c.converter_id, c.converter_val)
        select arg_Usr_CD, almn_id
         from almn 
         where almn_id in 
               (select am.almn_id 
                     from almn_merged am
         ...
         ---
         -- 3:
         OPEN rc_getListOfJobs  FOR
         select job_almn_id,
                job_num,
                --job_pgm_id,
                DECODE(job_title_txt, '', 'no data',
                                      null, 'no data', job_title_txt) as job_title_txt,
                
                DECODE(job_crnt_ind, '', '-1',
                                      null, '-1', job_crnt_ind) as job_crnt_ind,
                DECODE(job_instn_nm, '', 'no data',
                                      null, 'no data', job_instn_nm) as job_instn_nm,
                --job_crtd_dt,
                --job_crtd_id,
                --job_updt_dt,
                --job_updt_id,
                --original_almn_id,
                DECODE(pgm_src_nm, '', 'no data',
                                      null, 'no data', pgm_src_nm) as pgm_src_nm
           from job j, converter c
           where j.job_almn_id = c.converter_val
                 and
                 c.converter_id = arg_Usr_CD;
       -- 4:
       delete converter c
       where c.converter_id = arg_Usr_CD;
       ---
...
EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_getListOfJobs');
---------------------------------
---------------------------------
  End sp_getListOfJobs;
  ---================================================================================
  procedure sp_saveOrgRecords(arg_Usr_CD IN NUMBER,
                              arg_MRG_ALMN_ID IN NUMBER)
  is
  ...
  Begin
       ...
       -- I.1:
        ...
        select arg_Usr_CD, almn_id
         ...
         -- I.3: 
         insert into job_merged
           select j.*, 'E', arg_MRG_ALMN_ID, 'P', arg_Usr_CD
             from job j, converter c
             where j.job_almn_id = c.converter_val
                   and
                   c.converter_id = arg_Usr_CD;
          ...
          -- I.4
          update job_merged jm
          set jm.job_merged_cd = 'M'
          where jm.job_almn_id = arg_MRG_ALMN_ID;
          ---
          commit;
          ---
          ...
          -- I.5
          delete job j
           where j.job_almn_id in (select c.converter_val
                                   from converter c 
                                   where j.job_almn_id = c.converter_val
                                         and
                                         c.converter_id = arg_Usr_CD );
          ...
          EXCEPTION WHEN OTHERS THEN
              v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
              insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
              values (sysdate, v_ErrorMsg, arg_Usr_CD, 'sp_saveOrgRecords');
         ---------------------------------
         ---------------------------------
         
  End sp_saveOrgRecords;
  ---================================================================================
  procedure sp_mergeJobRecords(arg_MergeJobRecds IN VARCHAR2)
  is
  v_ErrorMsg VARCHAR2(200);
 -- v_sysdate date;
  ...
  Begin
      ...
      EXECUTE IMMEDIATE arg_MergeJobRecds;
      commit;
      
 EXCEPTION WHEN OTHERS THEN
    v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, arg_MergeJobRecds, 0, 'sp_mergeJobRecords');
    insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
    values (sysdate, v_ErrorMsg, 0, 'sp_mergeJobRecords');
  ---------------------------------
  ---------------------------------
  
  End sp_mergeJobRecords;
  ---================================================================================
  ...
  Begin
       update job_merged jm
          set jm.merge_status = 'C'
          where jm.merged_group_id = arg_MRG_ALMN_ID and jm.merge_status = 'P';
       commit;
  EXCEPTION WHEN OTHERS THEN
              v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
              insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
              values (sysdate, v_ErrorMsg, arg_MRG_ALMN_ID, 'sp_completeJobMerge');
  End sp_completeJobMerge;
   ---================================================================================
   procedure sp_mergePgm_and_PV(arg_Usr_CD IN NUMBER,
                              arg_MRG_ALMN_ID IN NUMBER,
                              arg_PgmID_AlmnID_Checked IN VARCHAR2,
  ...
  v_separator NUMBER;
  v_separator2 NUMBER;
  vPgmID_AlmnID_Checked VARCHAR2(200);
  v_PGM_ALMN VARCHAR2(40);
  v_PGM VARCHAR2(20);
  v_ALMN VARCHAR2(20);
  v_new_PGM NUMBER;
  vExecStr VARCHAR2(400);
  vPlaceVisited_Checked VARCHAR2(4000);
  v_place VARCHAR2(300);
  v_city VARCHAR2(60);
  v_state VARCHAR2(40);
  v_host_inst VARCHAR2(200);
  v_place_num number;
  v_count number;
  v_count_all_pgm number; -- v_count := v_count_all_pgm - v_count_merged_pgm; should be returned back to CF to determine if merge is finished or 
                          -- user should be returned to the List of Programs to continue merge.   
                             -- "0" - return user to the refreshed Search Summary, 
                             -- > "0" - return user back to List of Programs 
  v_count_merged_pgm number;
  v_stop number;
  
  
  Begin
  
  --1. Cut arg_PgmID_AlmnID_Checked to get ALMN_PGM_ID pairs to merge programs
    
  vPgmID_AlmnID_Checked  := arg_PgmID_AlmnID_Checked;
  select pgm_seq.nextval into v_new_PGM from dual;
  
  select DISTINCT merge_orig_pgm_count
  into v_count_all_pgm
  from ALMN_MERGED AM
  where AM.MERGED_GROUP_ID = arg_MRG_ALMN_ID and AM.MERGE_USR_ID = arg_Usr_CD and AM.MERGE_STATUS = 'P';
  
 v_stop := 1;
  
   while Length(vPgmID_AlmnID_Checked ) >0 loop
     
           -- 1
           select Instr(vPgmID_AlmnID_Checked , ';', 1, 1)
           into vPosOfDelimiter
           from dual;
           
           -- 2
           select Substr( vPgmID_AlmnID_Checked, 1, (vPosOfDelimiter-1) )
           into v_PGM_ALMN 
           from dual;
           
           select Instr(v_PGM_ALMN , '_', 1, 1)
           into v_separator
           from dual;
           
           select Substr( v_PGM_ALMN, 1, ( v_separator-1) )
           into v_PGM 
           from dual;
           
           select Substr( v_PGM_ALMN, ( v_separator+1) )
           into  v_ALMN
           from dual;
    --2. insert into pgm_merged orig PGM records         
           insert into pgm_merged (select p.*, 'E', TO_CHAR(v_new_PGM),TO_CHAR(arg_MRG_ALMN_ID), 'P', TO_CHAR(arg_Usr_CD) from PGM p where pgm_id = v_PGM and pgm_almn_id = v_ALMN);
           
        v_stop := 2;
    --3. insert into place_visit_merged orig PV records                
           insert into place_visit_merged (select PV.*,'E', TO_CHAR(v_new_PGM),TO_CHAR(arg_MRG_ALMN_ID), 'P', TO_CHAR(arg_Usr_CD) from PLACE_VISIT PV where place_visit_pgm_id = v_PGM and place_visit_almn_id = v_ALMN);
        v_stop := 3; 
     --4. delete PV records for ALMN_PGM_ID pairs 
          delete place_visit where place_visit_pgm_id = v_PGM and place_visit_almn_id = v_ALMN;    
        v_stop := 4;    
     --5. delete PGM records for ALMN_PGM_ID pairs 
          delete pgm where pgm_id = v_PGM and pgm_almn_id = v_ALMN; 
        v_stop := 5;  
           select Substr( vPgmID_AlmnID_Checked, (vPosOfDelimiter+1) )
           into vPgmID_AlmnID_Checked
           from dual;
     -- Delete ALMN records where almn_id != arg_MRG_ALMN_ID if no PGM records exists   
          If   v_ALMN != arg_MRG_ALMN_ID Then
               select count(*)
               into v_count
               from pgm
               where pgm_almn_id = v_ALMN;
               
               If v_count = 0 Then
                  delete almn where almn_id =  v_ALMN; 
                  v_stop := 6;
               End If;
          End If;
 ...
 select count(pgm_id)
  into v_count_merged_pgm
  from pgm_merged
  where pgm_almn_id in (select almn_id from almn_merged where merged_group_id = arg_MRG_ALMN_ID)
  and merged_group_almn_id = arg_MRG_ALMN_ID  and
         merge_usr_id = arg_Usr_CD ;
   v_stop := 7;      
  --6. insert new PGM record (create new PGM id from pgm_seq)
         insert into pgm
           (pgm_id,
            pgm_almn_id,
            pgm_type_cd,
         ...
         values
           (v_new_PGM,
            arg_MRG_ALMN_ID,
            arg_pgm_type_nm,
            TO_NUMBER(arg_pgm_fy_dt),
            TO_NUMBER(arg_pgm_yr_dt),
            TO_DATE(arg_pgm_start_dt, 'MM/DD/YYYY'),
            TO_DATE(arg_pgm_end_dt, 'MM/DD/YYYY'),
            arg_pgm_from_cntry_nm ,
            arg_pgm_to_cntry_nm,
            decode(arg_pgm_field_stdy_nm,-1,null,arg_pgm_field_stdy_nm),
            arg_pgm_agcy_nm,
            arg_pgm_plcmnt_org_nm,
            arg_pgm_nmtng_org_nm,
            arg_pgm_sub_ctgry_txt,
            arg_pgm_topic_txt,
            arg_pgm_strtgc_goal_txt,
            arg_pgm_spcl_award_txt,
            SYSDATE,
            arg_Usr_CD,
            SYSDATE,
            arg_Usr_CD,
...
v_stop := 8;
  --7. Cut arg_PlaceVisited_Checked to get records to insert  
  vPlaceVisited_Checked := arg_PlaceVisited_Checked ;
  v_place_num := 0;
   v_separator := 0;
  v_separator2 := 0;
   
   While Length(vPlaceVisited_Checked ) >0 Loop
   
           v_place_num := v_place_num + 1;                           
           -- 1
           select Instr(vPlaceVisited_Checked , '?', 1, 1)
           into vPosOfDelimiter
           from dual;
           
           -- 2
           select Substr( vPlaceVisited_Checked, 1, (vPosOfDelimiter - 1) )
           into   v_place 
           from dual;
           
           select Instr(v_place , '!', 1, 1)
           into v_separator
           from dual;
           
           select Substr( v_place, 1, ( v_separator - 1) )
           into v_city
           from dual;
           
           If v_city = 'no data' Then 
              v_city := null ;      
           End If;
                      
           select Instr(v_place , '!', 1, 2)
           into v_separator2
           from dual;
           
           select Substr( v_place, ( v_separator + 1), ( v_separator2 - ( v_separator + 1) ))
           into v_state
           from dual;
           ...
           select Substr( v_place , ( v_separator2 + 1) )
           into  v_host_inst
           from dual;
           
           If v_host_inst = 'no data' Then 
              v_host_inst := null;       
           End If;
           
           select Substr( vPlaceVisited_Checked, (vPosOfDelimiter + 1) )
           into vPlaceVisited_Checked
           from dual;
      --8. Insert new PV records with pgm_almn_id = arg_MRG_ALMN_ID and pgm_id = new ID from pgm_seq)
           insert into place_visit
             (place_visit_pgm_id,
              place_visit_almn_id,
              place_visit_num,
              place_visit_city_nm,
              place_visit_state_prvnc_nm,
              place_visit_cntry_cd,
              place_visit_host_instn_nm,
              place_visit_crtd_dt,
              place_visit_crtd_id,
              place_visit_updt_dt,
              place_visit_updt_id,
     ...
     v_separator2 := 0;
  End Loop;
  -- 9. Change record status in pgm_merged, place_visit_merged, almn_merged to 'C' (complete)

  
  update place_visit_merged
     set merge_status = 'C'
   where merged_group_almn_id = arg_MRG_ALMN_ID and 
         merged_group_pgm_id = v_new_PGM and
         merge_usr_id = arg_Usr_CD and 
         merge_status = 'P';
  ...
  v_stop := 11;
  --10. Find out if more pgm records exist for merge:
   
  v_count := v_count_all_pgm - v_count_merged_pgm;
  
  If v_count = 0 Then       
      update almn_merged
         set merge_status = 'C'
       where merged_group_id = arg_MRG_ALMN_ID and 
             merge_usr_id = arg_Usr_CD and 
             merge_status = 'P';
  ...
  End If;
   ...
   OPEN rc_continue FOR
       select v_count as vCount from dual;
   
  EXCEPTION WHEN OTHERS THEN
              v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
              insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
              values (sysdate, v_ErrorMsg, arg_MRG_ALMN_ID, TO_CHAR(arg_pgm_type_nm)||' '||To_Char(v_stop)||'sp_mergePgm_and_PV');
              commit;
  
  End sp_mergePgm_and_PV;
  ---================================================================================
  procedure sp_getPgmType(rc_getPgmType  OUT refc_Base)
  is
  --
...
EXCEPTION WHEN OTHERS THEN
  v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
  insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
  values (sysdate, v_ErrorMsg, 0, 'sp_getPgmType');
  commit;
---
  End sp_getPgmType;
  ---================================================================================
  ...
  --
  Begin
       OPEN rc_getFieldOfStudy FOR
       select fs.field_stdy_cd as pgm_field_stdy_cd, 
              Replace (fs.field_stdy_nm, '''', '`') as pgm_field_stdy_nm
       from field_stdy fs
       order by 2;
---
EXCEPTION WHEN OTHERS THEN
  v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
  insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
  values (sysdate, v_ErrorMsg, 0, 'sp_getFieldOfStudy');
  commit;
---
  End sp_getFieldOfStudy; 
  ---================================================================================
  procedure sp_DelPendingMergedRecds (arg_Usr_CD IN NUMBER)
  is
  --
  ...
  Begin
       ...
       insert into converter
               (converter_id, converter_val)
       select almn_updt_id,  almn_id
       from almn_merged
        where almn_updt_id = arg_Usr_CD 
              and
              merge_status = 'P';
       ---
       commit;
...
EXCEPTION WHEN OTHERS THEN
  v_ErrorMsg := SUBSTR(SQLERRM, 1, 200);
  insert into error_msg em (error_dt_tm, error_txt, error_usr_id, ERROR_SP_NM)
  values (sysdate, v_ErrorMsg, 0, 'sp_DelPendingMergedRecds');
  commit;
---       
       
  End sp_DelPendingMergedRecds;
  ---================================================================================
   procedure sp_getProminent_Categories (spr_Prominent_Categories OUT refc_Base)
is
Begin
     OPEN spr_Prominent_Categories FOR
     select item_cd, item_desc 
     from code_lk t
     where t.item = 'PROMINENT_CD'
     order by item_desc;


End sp_getProminent_Categories;
  ---================================================================================
  ---================================================================================
  ---  FUNCTIONS
  ---================================================================================
  ...
  */
  ...
  is
    v_RtnVal VARCHAR2(100);
  Begin
   select item_desc into v_RtnVal
        from code_lk 
   where item = 'PROMINENT_CD' and item_cd = Trim(arg_prominent_cd);
    
    return v_RtnVal;
      ---
  End f_getProminentNM;
  ---================================================================================
  ---================================================================================
  ---================================================================================
  ---================================================================================
