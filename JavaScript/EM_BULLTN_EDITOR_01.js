	...
	"<table align=\"center\" style=\"background-color:#CCCCCC; border-style:none;\" width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"2\">"+
			"<tr>"+
					"<td align=\"center\">"+
						...
						"&nbsp;&nbsp;&nbsp;&nbsp;"+"&nbsp;&nbsp;&nbsp;&nbsp;"+
						"<input type=\"button\" name=\"cb_IdentRecord\" onclick=\"f_onClick(this.name)\" value=\"Create Identical Record\" />"+
						"&nbsp;&nbsp;&nbsp;&nbsp;"+"&nbsp;&nbsp;&nbsp;&nbsp;"+
	...
	switch(arg_CtrlName)
    {
		...
		case "sel_ModOrder_Type":
			if (v_CtrlValue == "SMO")
			{
				...
				of_outPut("span_SoftVer_Asterisk", "<font color=\"#FF0000\" >*</font>"+"<font color=\"#FF0000\" >&amp;</font>"); 
			}
			else 
			{
...
//"txt_ModOrder_WorkOrder"
			...
			if ( v_ValidationPassed == "YES")
			{
				v_ValidationPassed = f_validateWorkOrder();
			}
			//
			if ( v_ValidationPassed == "YES")
			{// TEST: alert(v_ValidationPassed)
				f_Save();
			}
			//............................................................................
		break;
...
//========================================================================================
function f_createIdenticalEntry(){with(self.document.forms[0])
{
		//--------------------------------------------------------------------------------
/*	  	var arrayCtrlNames = new Array( ////// FIND RECORD:
	  	...
	  	var v_listOfBulletins = "";
		var v_ModOrder_Type = "";
		var v_ModOrder_Num_Seq = "";
		var v_ModOrder_Year = "";
		var v_ModOrder_Date_Issued = "";
		var v_ModOrder_Date_Due = "";
		var v_ModOrder_SoftVer = "";
		var v_ModOrder_Descr = "";
		var v_ModOrder_Comments = "";
		var v_ModOrder_WorkCodes = "";
		var v_ModOrder_ActionCode = "";
		var v_ModOrder_EstHours = "";
		var v_NSN_1_4 = "";
		var v_NSN_2_2 = "";
		var v_NSN_3_3 = "";
		var v_NSN_4_4 = "";
		//var v_ModOrder_Acronym = "";
		//var v_ModOrder_ClassCode = "";
		//var v_ModOrder_WorkOrder = "";
	  ...
	  {
		  alert("System cannot process your request."+
				"\nSelect a record you wish to use as a source \nin the control \"LIST OF BULLETINS\".");
		  sel_listOfBulletins.focus();
	  }
	  else
	  {
			
			of_getCtrlProperties("sel_listOfBulletins");      v_listOfBulletins = v_CtrlValue;
		    of_getCtrlProperties("sel_ModOrder_Type");        v_ModOrder_Type = v_CtrlValue;
		    of_getCtrlProperties("txt_ModOrder_Num_Seq");     v_ModOrder_Num_Seq = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_Year");        v_ModOrder_Year = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_Date_Issued"); v_ModOrder_Date_Issued = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_Date_Due");    v_ModOrder_Date_Due = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_SoftVer");     v_ModOrder_SoftVer = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_Descr");       v_ModOrder_Descr = v_CtrlValue;
			of_getCtrlProperties("txa_ModOrder_Comments");    v_ModOrder_Comments = v_CtrlValue;
			of_getCtrlProperties("sel_ModOrder_WorkCodes");   v_ModOrder_WorkCodes = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_ActionCode");  v_ModOrder_ActionCode = v_CtrlValue;
			of_getCtrlProperties("txt_ModOrder_EstHours");    v_ModOrder_EstHours = v_CtrlValue;
			of_getCtrlProperties("txt_NSN_1_4");  			  v_NSN_1_4 = v_CtrlValue;
			of_getCtrlProperties("txt_NSN_2_2");  			  v_NSN_2_2 = v_CtrlValue;
			of_getCtrlProperties("txt_NSN_3_3");  			  v_NSN_3_3 = v_CtrlValue;
			of_getCtrlProperties("txt_NSN_4_4");  			  v_NSN_4_4 = v_CtrlValue;			   
			//
			of_selectRecord("sel_listOfBulletins", "-1");
			f_onChange("sel_listOfBulletins");
			//
			of_selectRecord("sel_ModOrder_Type",              v_ModOrder_Type);
			of_setSingleValue("txt_ModOrder_Num_Seq", 	  "'"+v_ModOrder_Num_Seq+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_Year", 		  "'"+v_ModOrder_Year+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_Date_Issued", "'"+v_ModOrder_Date_Issued+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_Date_Due",	  "'"+v_ModOrder_Date_Due+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_SoftVer",	  "'"+v_ModOrder_SoftVer+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_Descr",		  "'"+v_ModOrder_Descr+"'", "", "", 0);
			of_setSingleValue("txa_ModOrder_Comments",	  "'"+v_ModOrder_Comments+"'", "", "", 0);
			of_selectRecord("sel_ModOrder_WorkCodes",         v_ModOrder_WorkCodes);
			of_setSingleValue("txt_ModOrder_ActionCode",  "'"+v_ModOrder_ActionCode+"'", "", "", 0);
			of_setSingleValue("txt_ModOrder_EstHours",    "'"+v_ModOrder_EstHours+"'", "", "", 0);
			of_setSingleValue("txt_NSN_1_4",              "'"+v_NSN_1_4+"'", "", "", 0);
			of_setSingleValue("txt_NSN_2_2", 			  "'"+v_NSN_2_2+"'", "", "", 0);
			of_setSingleValue("txt_NSN_3_3",			  "'"+v_NSN_3_3+"'", "", "", 0);
			of_setSingleValue("txt_NSN_4_4",			  "'"+v_NSN_4_4+"'", "", "", 0);
	  }
}}
//========================================================================================
function f_isThisANewRecord(){with(self.document.forms[0])
{
	...
	else // <-- Existing record
	{
		for (var r=0; r<orgBfr_BulletinList.length; r++)
		{
			if (v_CtrlValue == orgBfr_BulletinList[r].a_bulletin_ptr)
			{
				...
				else //v_WasThisRecordLinkedToWO = "Y"
				{
					...
					v_DateDue = orgBfr_BulletinList[r].a_date_due;
					//
					//of_getCtrlProperties("txt_ModOrder_EstHours");
					//v_Est_hours
					break;
				}
			}
		...
		// v_DateDue has a value that was saved in the database.
		// Comparisson of variables v_DateDue and v_CtrlValue determines wether "Due Date" was changed, or not.
		//
		if (v_WasThisRecordLinkedToWO == "Y" && (v_CtrlValue != v_DateDue))
		{
		...
		else if (v_WasThisRecordLinkedToWO == "Y" && (v_CtrlValue == v_DateDue))
		{
			v_RtnYESorNO = "NO";
...
//========================================================================================
function f_validateWorkOrder(){with(self.document.forms[0])
{	
	var v_RtnYESorNO = "YES";
	// TEST:
	//alert("EMAPP.EM_BULLTN_EDITOR_01.sp_validateWorkOrder?p_Bulletin_Ptr="+document.getElementById("sel_listOfBulletins").value+
	//														   "&p_WorkOrder="+document.getElementById("txt_ModOrder_WorkOrder").value+
	//														   "&p_FiscalYear="+document.getElementById("txt_ModOrder_Year").value);
	
	objAJAX.load("EMAPP.EM_BULLTN_EDITOR_01.sp_validateWorkOrder?p_Bulletin_Ptr="+document.getElementById("sel_listOfBulletins").value+
															   "&p_WorkOrder="+document.getElementById("txt_ModOrder_WorkOrder").value+
															   "&p_FiscalYear="+document.getElementById("txt_ModOrder_Year").value);
	if (objAJAX.parsed)
	{
	...
	{
		alert("System cannot process your request.\n"+
			  "Work Order Number ("+document.getElementById("txt_ModOrder_WorkOrder").value+") had been used within "+
			  					  "Fiscal Year '"+document.getElementById("txt_ModOrder_Year").value+".\n"+
			  "Please reconsider your entry.");
			  txt_ModOrder_WorkOrder.focus();
	}
