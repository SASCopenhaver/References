...
function of_ExpandOrColapse(what)
{
...
<table align="left" cellspacing="2" cellpadding="2" border="0" class="Teal8">
<tr>
    <td>
		<strong>Instructions:</strong>
		&nbsp;&nbsp;&nbsp;
		<a href="javascript: of_ExpandOrColapse('instr');">
		<img src="Img/Instruction.JPG" width="30" height="33" alt="" border="0" alt="Instruction.<br>Click on picture" title="Instruction. Click on picture">
		</a><!--- &nbsp;
		<font class="Teal8">(Click on me)</font> --->
	</td>
</tr>
...
<table align="left" cellspacing="2" cellpadding="2" border="1" class="Teal8">
...
--->
	...
	<br>
	<strong>B.</strong> Agree with encourage it.
	<br>
	<strong>C.</strong> Consider it not important.
	<br>
	<strong>D.</strong> Disagree withor discourage it.
	<br>
