...
prompt Truncating USERS...
truncate table USERS;
prompt Loading USERS...
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (1, 'SERGEY', 'SURIKOV', 'sas', 'ssuriov@usa-ctc.com', 'A', 0);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (2, 'WILLIAM', 'GOODWIN', 'wg', 'wgoodwin2@pd.state.net', 'A', 0);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (3, 'SANA', 'ABED-KOTOB', 'saab', 'EMAIL', 'A', 2);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (4, 'MAGGIE', 'AHERN', 'pass', 'email', 'A', 2);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (5, 'WILLIAM', 'ANCKER', 'pass', 'EMAIL', 'I', 2);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
...
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
values (9, 'MARY', 'ASHSLEY', 'pass', 'email', 'A', 2);
insert into USERS (IDS, FNAME, LNAME, PASS, EMAIL, ACT_INACT, ORG_ID)
