...
local.PartNameListForConfirm=#local.PartNameListForConfirm#<br>
 ...
 --->
	<!--- <cfloop index="Email_To" list="SurikovSA@state.gov; SurikovSA@state.gov; SurikovSA@state.gov;" delimiters=";"> --->
 <cfloop index="Email_To" list="#local.emailTo#" delimiters=";">
	<cfmail to="#local.emailFrom#" from="#Email_To#" server="127.0.0.1" subject="Project: #FORM.h_PrjName#">
	#local.EMailMsg#
	</cfmail>
</cfloop>

<!--- Confirmation to the Sender --->
<cfmail to="#local.emailFrom#" from="#local.emailFrom#" server="127.0.0.1"  subject="E-Mail confirmation for the Project: #FORM.h_PrjName#">
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
<cfstoredproc procedure="questination.PACK_INSUPD.sp_InsUpdEMail" datasource="#client.DSN#" returncode="No">
