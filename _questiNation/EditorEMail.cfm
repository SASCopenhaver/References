...
<cfstoredproc procedure="questination.PACK_SELECT_ALL.sp_AllPrjsForEMail" datasource="#client.DSN#" returncode="No">
...
<cfstoredproc procedure="questination.PACK_SELECT_ALL.sp_selectPartsStatForEMail" datasource="#client.DSN#" returncode="No">
			...
			<td class="Brown9">
				...
				<tr>
					<td width="50%" class="Brown9" colspan="3">
						URL/Address:<input size="40" value="http://org-norms.pd.state.gov" type="Text" name="txt_DefaultURL" onChange="javascript:while(''+this.value.charAt(this.value.length-1)==' ')this.value=this.value.substring(0,this.value.length-1);while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);">
					</td>
				</tr>
				<tr>
