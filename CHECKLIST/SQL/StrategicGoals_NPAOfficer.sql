Strategic  Goals
  ...
  SELECT "USIA"."PROJECT_GOAL"."PGOAL_PROJECT_ID",   
         "USIA"."PROJECT_GOAL"."PGOAL_STRAT_GOAL_ID",   
         "USIA"."PROJECT_GOAL"."PGOAL_PRIMARY",   
         "USIA"."STRATEGIC_GOAL"."STRATEGIC_GOAL_NM"
  
    FROM "USIA"."PROJECT_GOAL",   
         "USIA"."STRATEGIC_GOAL"  

   WHERE ( USIA."PROJECT_GOAL"."PGOAL_PROJECT_ID" = :project_id ) AND  
         ( USIA."PROJECT_GOAL"."PGOAL_STRAT_GOAL_ID" = USIA."STRATEGIC_GOAL"."STRATEGIC_GOAL_ID" )    
