...
*/
  ...
  Begin
      ...
      where su.su_userid = argUserID
            ...
            ---
           -- and p.per_person_id = pe.pem_person_id
           -- and pe.pem_preferred = 'Y'
      ;
...
-- The following SELECT applies to Version 1.  It has unnecessarily "joins" 
-- Below commented script find a replacemetn SELECT statement
/*
   ...
   */         
   -- RPLACEMENT SELECT statement
   OPEN rc_DistinctListOfPOsInDoS FOR
   SELECT DISTINCT
          "USIA"."PERSON"."PER_PERSON_ID" as DoSPrgramOffiserID
         ,"USIA"."PERSON"."PER_SORT_NAME" as DoSProgramOfficerName
         ,pem.pem_email   as DosProgramOfficerEMail                    --
--, 
--"USIA"."PERSON"."PER_FIRST_NAME", 
--"USIA"."PERSON"."PER_LAST_NAME", 
    ...
    FROM "USIA"."PERSON", 
     ...
     WHERE ( "USIA"."PERSON"."PER_PERSON_ID" = "USIA"."PER_ORG_ROLE"."POR_PERSON_ID" ) 
         ...
         (
            ...
            AND
            (pem.pem_person_id = "USIA"."PERSON"."PER_PERSON_ID"
             and
             pem.pem_preferred = 'Y'
            )
            ;
